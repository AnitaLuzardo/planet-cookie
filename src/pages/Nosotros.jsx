...
import Fruit from "../images/frutas-removebg.png"
      ...
      <div className='container_scroll'>
        <div className='content_container_us'>
          <div className='content_planet'>
            ...
            <p className='content_text'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
              Dicta necessitatibus ad architecto.</p>
          </div>
          <div className='content_planet'> 
            <h2 className='oval-half-red'>Avena sin gluten</h2>
            <img className='img_Nosotros gluten_free' src={GlutenFree} alt="" />
          </div>
          <div className='content_planet'>
            <h2 className='oval-half-red'>Sabores naturales</h2>
            <img className='img_Nosotros frut_img' src={Fruit} alt="" />
          </div>
          <div className='content_planet'>
